...
from synapse.api.constants import EventTypes, GenericEventFieldsNames
...
class EventsStore(
    ...
    def _update_metadata_tables_txn(
        ...
        for event, _ in events_and_contexts:
            ...
            labels = event.content.get(GenericEventFieldsNames.Labels)
            if labels:
                self.set_labels_for_event_txn(txn, event.event_id, labels)
    ...
    def set_labels_for_event_txn(self, txn, event_id, labels):
